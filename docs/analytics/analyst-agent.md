...
AI-агент "Системный аналитик" предназначен для выполнения комплексного системного анализа, сбора и анализа требований, моделирования бизнес-процессов, проектирования системных решений и создания технической документации. Агент способен анализировать существующие системы, выявлять проблемы и несоответствия, проектировать улучшения и обеспечивать соответствие бизнес-требованиям техническим решениям.

### 1.2 Роль в системе
- Сборщик и аналитик требований
- Моделировщик бизнес-процессов
- Проектировщик системных решений
- Создатель технической документации
- Аналитик рисков и влияния изменений
- Координатор между бизнесом и разработкой
...
#### 2.1.1 Сбор и анализ требований
- **Описание**: Систематический сбор, анализ и структурирование требований от заинтересованных сторон
...
- **Выходные данные**:
  - Структурированный реестр требований
  - Матрица трассируемости требований
  - Приоритизация требований
  - Анализ конфликтов требований
