...
📖 **Руководства:**
- **[docs/guides/USER_GUIDE.md](docs/guides/USER_GUIDE.md)** - 📖 **полное руководство пользователя** (начните отсюда!)
- [docs/troubleshooting/CHECK_ME.md](docs/troubleshooting/CHECK_ME.md) - быстрая проверка для пользователей
- [docs/guides/QUICKSTART.md](docs/guides/QUICKSTART.md) - быстрый старт
- [docs/troubleshooting/HOW_TO_CHECK.md](docs/troubleshooting/HOW_TO_CHECK.md) - подробная диагностика

## Документация

### Руководство пользователя

- **[docs/guides/USER_GUIDE.md](docs/guides/USER_GUIDE.md)** - 📖 **Полное руководство по использованию системы** (начните отсюда!)
